...
const initArticleReadTimeChart = (readTime) => {
  let chart = echarts.init(post_selectors.articleTotalReadTimeChart);
  let series = {
    name: "Pressure",
    type: "gauge",
    detail: {
...
const initArticleTotalReadTimeChart = (data) => {
  let chart = echarts.init(post_selectors.articleReadTimeChart);
...
const initReadTimeChart = (data) => {
  const chart = echarts.init(post_selectors.readTimeChart);
  let dataa = [
    {
      value: 100,
      name: "SCORE",
...
const initCompletionRateForArticleChart = (data) => {
  const chart = echarts.init(post_selectors.completionRateForArticleChart);
  const breakdown =
    data.percentages["Total Read Completion Rate"][
...
const initInteractionTypeCountWithName = (data) => {
  const chart = echarts.init(post_selectors.interactionTypeCountWithName);
...
const initArticleInteractionScoreByAudienceType = (data) => {
  ...
  const chart = echarts.init(
    post_selectors.articleInteractionScoreByAudienceType
  );
